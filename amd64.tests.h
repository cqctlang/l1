...
//	test(                                            IMUL(p, RAX, RDX),   "\x48\x0f\xaf\xc2"                                 );	//  16
//	test(                                         IMUL(p, RAX, RDX, 3),   "\x48\x6b\xc2\x03"                                 );	//  17
//	test(                IMUL(p, RAX, indirecti(RCX, RDX, 0x12345678)),   "\x48\x0f\xaf\x84\x11\x78\x56\x34\x12"             );	//  18
//	test(             IMUL(p, RAX, indirecti(RCX, RDX, 0x12345678), 3),   "\x48\x6b\x84\x11\x78\x56\x34\x12\x03"             );	//  19
//	test(    IMUL(p, RAX, indirecti(RCX, RDX, 0x12345678), 0x12345678),   "\x48\x69\x84\x11\x78\x56\x34\x12\x78\x56\x34\x12" );	//  20
//	test(                                              ROL(p, EDX, CL),   "\xd3\xc2"                                         );	//  21
//	test(                                              ROL(p, EDX, 31),   "\xc1\xc2\x1f"                                     );	//  22
//	test(                                              ROR(p, EDX, CL),   "\xd3\xca"                                         );	//  23
//	test(                                              ROR(p, EDX, 31),   "\xc1\xca\x1f"                                     );	//  24
//	test(                                              ROL(p, RDX, CL),   "\x48\xd3\xc2"                                     );	//  25
//	test(                                              ROL(p, RDX, 31),   "\x48\xc1\xc2\x1f"                                 );	//  26
//	test(                  ROL(p, indirecti(RCX, RDX, 0x12345678), CL),   "\x48\xd3\x84\x11\x78\x56\x34\x12"                 );	//  27
//	test(                  ROL(p, indirecti(RCX, RDX, 0x12345678), 31),   "\x48\xc1\x84\x11\x78\x56\x34\x12\x1f"             );	//  28
//	test(                                              ROR(p, RDX, CL),   "\x48\xd3\xca"                                     );	//  29
//	test(                                              ROR(p, RDX, 31),   "\x48\xc1\xca\x1f"                                 );	//  30
//	test(                  ROR(p, indirecti(RCX, RDX, 0x12345678), CL),   "\x48\xd3\x8c\x11\x78\x56\x34\x12"                 );	//  31
//	test(                  ROR(p, indirecti(RCX, RDX, 0x12345678), 31),   "\x48\xc1\x8c\x11\x78\x56\x34\x12\x1f"             );	//  32
//	test(                                              RCL(p, RDX, 31),   "\x48\xc1\xd2\x1f"                                 );	//  33
//	test(                                              RCR(p, RDX, 31),   "\x48\xc1\xda\x1f"                                 );	//  34
//	test(                                              SHL(p, RDX, 31),   "\x48\xc1\xe2\x1f"                                 );	//  35
//	test(                                              SHR(p, RDX, 31),   "\x48\xc1\xea\x1f"                                 );	//  36
//	test(                                              SAR(p, RDX, 31),   "\x48\xc1\xfa\x1f"                                 );	//  37
//	test(                                                     LEAVE(p),   "\xc9"                                             );	//  38
//	test(                                                       RET(p),   "\xc3"                                             );	//  39
//	test(                                               RET(p, 0x1234),   "\xc2\x34\x12"                                     );	//  40
//	test(                                                     CPUID(p),   "\x0f\xa2"                                         );	//  41
//	test(                                                       NOP(p),   "\x90"                                             );	//  42
//	test(                                                     RDTSC(p),   "\x0f\x31"                                         );	//  43
//	test(                                                     RDPMC(p),   "\x0f\x33"                                         );	//  44
//	test(                                            JO(p, 0x12345678),   "\x0f\x80\x78\x56\x34\x12"                         );	//  45
//	test(                                           JNO(p, 0x12345678),   "\x0f\x81\x78\x56\x34\x12"                         );	//  46
//	test(                                            JB(p, 0x12345678),   "\x0f\x82\x78\x56\x34\x12"                         );	//  47
//	test(                                           JAE(p, 0x12345678),   "\x0f\x83\x78\x56\x34\x12"                         );	//  48
//	test(                                            JE(p, 0x12345678),   "\x0f\x84\x78\x56\x34\x12"                         );	//  49
//	test(                                           JNE(p, 0x12345678),   "\x0f\x85\x78\x56\x34\x12"                         );	//  50
//	test(                                           JBE(p, 0x12345678),   "\x0f\x86\x78\x56\x34\x12"                         );	//  51
//	test(                                            JA(p, 0x12345678),   "\x0f\x87\x78\x56\x34\x12"                         );	//  52
//	test(                                            JS(p, 0x12345678),   "\x0f\x88\x78\x56\x34\x12"                         );	//  53
//	test(                                           JNS(p, 0x12345678),   "\x0f\x89\x78\x56\x34\x12"                         );	//  54
//	test(                                            JP(p, 0x12345678),   "\x0f\x8a\x78\x56\x34\x12"                         );	//  55
//	test(                                           JNP(p, 0x12345678),   "\x0f\x8b\x78\x56\x34\x12"                         );	//  56
//	test(                                            JL(p, 0x12345678),   "\x0f\x8c\x78\x56\x34\x12"                         );	//  57
//	test(                                           JGE(p, 0x12345678),   "\x0f\x8d\x78\x56\x34\x12"                         );	//  58
//	test(                                           JLE(p, 0x12345678),   "\x0f\x8e\x78\x56\x34\x12"                         );	//  59
//	test(                                            JG(p, 0x12345678),   "\x0f\x8f\x78\x56\x34\x12"                         );	//  60
//	test(                                                 CALL(p, ECX),   "\xff\xd1"                                         );	//  61
//	test(                                                 CALL(p, RCX),   "\x48\xff\xd1"                                     );	//  62
//	test(                                          CALL(p, 0x12345678),   "\xe8\x78\x56\x34\x12"                             );	//  63
...
//	test(                                           JMP(p, 0x12345678),   "\xe9\x78\x56\x34\x12"                             );	//  68
...
//	test(                                          PUSH(p, 0x12345678),   "\x68\x78\x56\x34\x12"                             );	//  75
...
//	test(                                                 IMUL(p, RAX),   "\x48\xf7\xe8"                                     );	//  92
//	test(                     IMUL(p, indirecti(ECX, EDX, 0x12345678)),   "\xf7\xac\x11\x78\x56\x34\x12"                     );	//  93
//	test(                     IMUL(p, indirecti(RCX, RDX, 0x12345678)),   "\x48\xf7\xac\x11\x78\x56\x34\x12"                 );	//  94
...
//	test(                                               MOV(p, ECX, 1),   "\xb9\x01\x00\x00\x00\x00\x00\x00\x00"             );	// 187
...
//	test(                                               ADD(p, ECX, 1),   "\x83\xc1\x01"                                     );	// 195
//	test(                                               ADD(p, ECX, 1),   "\x83\xc1\x01"                                     );	// 196
//	test(                                             ADD(p, ECX, 150),   "\x81\xc1\x96\x00\x00\x00"                         );	// 197
